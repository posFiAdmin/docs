...
<Steps>
  ...
  <Step title="Borrow, Loop, or Leverage">
    Simply Borrow liquidity on Positions's Lend/Borrow Market or deploy advanced strategies like betting more, going delta neutral, looping for yield, or leveraging on perps — all backed by your active collateral.
  </Step>
</Steps>
...
<Card title="Retain-First Design" icon="sparkles">
